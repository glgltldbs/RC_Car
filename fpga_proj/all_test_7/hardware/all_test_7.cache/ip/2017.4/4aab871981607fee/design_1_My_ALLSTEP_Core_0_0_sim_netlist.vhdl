...
PAST_Z_SIG_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => Z_SIG,
...
\duty[14]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C8CFCCCC"
    )
        port map (
...
\period[15]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFB"
    )
        port map (
...
\period[15]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\period[15]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\period[15]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000004"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_My_ALLSTEP_Core_v1_0 is
  signal My_ALLSTEP_Core_v1_0_S00_AXI_inst_n_5 : STD_LOGIC;
