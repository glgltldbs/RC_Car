...
proc create_root_design { parentCell } {
  ...
  set Z_SIG [ create_bd_port -dir I Z_SIG ]

  # Create instance: My_ALLSTEP_Core_0, and set properties
  set My_ALLSTEP_Core_0 [ create_bd_cell -type ip -vlnv user.org:user:My_ALLSTEP_Core:1.0 My_ALLSTEP_Core_0 ]

  # Create instance: My_SERVO_Core_0, and set properties
  set My_SERVO_Core_0 [ create_bd_cell -type ip -vlnv user.org:user:My_SERVO_Core:1.0 My_SERVO_Core_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins My_ALLSTEP_Core_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins My_SERVO_Core_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net My_ALLSTEP_Core_0_PWM1 [get_bd_ports PWM1] [get_bd_pins My_ALLSTEP_Core_0/PWM1]
  connect_bd_net -net My_SERVO_Core_0_PWM [get_bd_ports PWM] [get_bd_pins My_SERVO_Core_0/PWM]
  connect_bd_net -net PWM_SIG_1 [get_bd_ports PWM_SIG] [get_bd_pins My_ALLSTEP_Core_0/PWM_SIG]
  connect_bd_net -net Z_SIG_1 [get_bd_ports Z_SIG] [get_bd_pins My_ALLSTEP_Core_0/Z_SIG]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins My_ALLSTEP_Core_0/s00_axi_aclk] [get_bd_pins My_SERVO_Core_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins My_ALLSTEP_Core_0/s00_axi_aresetn] [get_bd_pins My_SERVO_Core_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs My_ALLSTEP_Core_0/S00_AXI/S00_AXI_reg] SEG_My_ALLSTEP_Core_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs My_SERVO_Core_0/S00_AXI/S00_AXI_reg] SEG_My_SERVO_Core_0_S00_AXI_reg
