...
HD_PWD='/home/siyun/vivado_workspace/all_test/hardware/all_test.runs/design_1_My_PWM_Core_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_My_PWM_Core_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_My_PWM_Core_0_0.tcl
