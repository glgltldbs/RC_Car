...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = My_ECAP_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = My_ECAP_Core_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = My_PWM_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = My_PWM_Core_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = My_Time_Core
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = My_Time_Core_0
END
